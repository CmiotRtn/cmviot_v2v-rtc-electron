...
import { LogFilterType, LogLevel } from '../ICmviotLog';
...
import { CmviotRhythmPlayerConfig } from '../ICmviotRhythmPlayer';
import {
...
export class IRtcEngineImpl implements IRtcEngine {
  ...
  configRhythmPlayer(config: CmviotRhythmPlayerConfig): number {
