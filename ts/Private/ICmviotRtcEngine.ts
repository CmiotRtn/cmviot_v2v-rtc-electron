...
import {
  CmviotRhythmPlayerConfig,
  RhythmPlayerErrorType,
  RhythmPlayerStateType,
} from './ICmviotRhythmPlayer';
...
export class RtcEngineContext {
  ...
  domainLimit?: boolean;
  /* class_rtcenginecontext_autoRegisterCmviotExtensions */
...
export abstract class IRtcEngine {
  ...
  /* api_irtcengine_preloadchannelwithuseraccount */
  ...
  /* api_irtcengine_startscreencapturebysourcetype */
  ...
  /* api_irtcengine_stopscreencapturebysourcetype */
  ...
  abstract startRhythmPlayer(
    sound1: string,
    sound2: string,
    config: CmviotRhythmPlayerConfig
  ): number;
