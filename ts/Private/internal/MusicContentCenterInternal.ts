...
import {
  ...
  IMusicPlayerImpl,
  MusicCollectionImpl,
} from '../impl/ICmviotMusicContentCenterImpl';
import ICmviotMusicContentCenterTI from '../ti/ICmviotMusicContentCenter-ti';
const checkers = createCheckers(ICmviotMusicContentCenterTI);
