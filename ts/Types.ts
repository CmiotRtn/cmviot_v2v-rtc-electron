 ...
 * @ignore
 */
export interface CmviotEnvOptions {
  /**
   * @ignore
   */
 ...
 * @ignore
 */
export interface CmviotEnvType extends CmviotEnvOptions {
  /**
   * @ignore
   */
  CmviotElectronBridge: CmviotElectronBridge;
  /**
   * @ignore
   */
  CmviotRendererManager?: IRendererManager;
}
 ...
 * @ignore
 */
export interface CmviotElectronBridge {
  /**
   * @ignore
   */
  OnEvent(
