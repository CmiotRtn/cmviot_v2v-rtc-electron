 ...
 * @ignore
 */
export const TAG = '[Cmviot]: ';
/**
 * @ignore
 */
export const DEBUG_TAG = '[Cmviot Debug]: ';
...
export const logDebug = (msg: string, ...optParams: any[]) => {
  if (!CmviotEnv.enableLogging || !CmviotEnv.enableDebugLogging) {
    return;
  }
...
export const getDefaultRendererVideoConfig = (
  ...
  const rendererOptions = Object.assign(
    {},
    CmviotEnv.CmviotRendererManager?.defaultRenderConfig?.rendererOptions,
...
const cmviot = require('../build/Release/cmviot_node_ext');

/**
 * @ignore
 */
export const CmviotEnv: CmviotEnvType = {
  enableLogging: true,
