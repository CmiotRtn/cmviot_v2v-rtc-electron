...
export declare class IRtcEngineImpl implements IRtcEngine {
    ...
    startRhythmPlayer(sound1: string, sound2: string, config: CmviotRhythmPlayerConfig): number;
    protected getApiTypeFromStartRhythmPlayer(sound1: string, sound2: string, config: CmviotRhythmPlayerConfig): string;
    ...
    protected getApiTypeFromConfigRhythmPlayer(config: CmviotRhythmPlayerConfig): string;
...
//# sourceMappingURL=ICmviotRtcEngineImpl.d.ts.map